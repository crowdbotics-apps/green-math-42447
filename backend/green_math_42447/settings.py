"""
Django settings for green_math_42447 project.
...
ROOT_URLCONF = 'green_math_42447.urls'
...
WSGI_APPLICATION = 'green_math_42447.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "green_math_42447 API",
    "DESCRIPTION": "API documentation for green_math_42447 App",
    "VERSION": "v1",
}
